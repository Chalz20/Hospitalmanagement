...
const AddNurse = () => {
  ...
  return (
    ...
    <div className="col-lg-4 mb-4">
     ...
     <div className="col-lg-4 mb-4">
       <p className="mb-0 text-muted">Nurse Email:</p>
       <Form.Group controlId="firstname">
     ...
     <div className="col-lg-4 mb-4">
       <p className="mb-0 text-muted">Nurse Password:</p>
       <Form.Group controlId="firstname">
     ...
     <div className="col-lg-4 mb-4">
       <p className="mb-0 text-muted">Nurse Address:</p>
       <Form.Group controlId="firstname">
     ...
     <div className="col-lg-4 mb-1">
      ...
      <div className="col-lg-4 mb-4">
       <p className="mb-0 text-muted">Nurse Profile:</p>
       <Form.Group controlId="firstname">
     ...
     <div className="row m-auto mt-3 ">
        ...
        <Link to=''>
        <button className="btn btn-primary mr-4" onClick={handleSubmit}><span className="p-1">< FaUserCheck/></span>Register Nurse</button> 
        </Link>
