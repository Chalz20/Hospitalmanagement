...
const AddDoctor = () => {
  ...
  return (
    ...
    <div className="col-lg-4 mb-4">
     ...
     <div className="col-lg-4 mb-4">
       <p className="mb-0 text-muted">Doctor Email:</p>
       <Form.Group controlId="firstname">
     ...
     <div className="col-lg-4 mb-4">
       <p className="mb-0 text-muted">Doctor Password:</p>
       <Form.Group controlId="firstname">
     ...
     <div className="col-lg-4 mb-4">
       <p className="mb-0 text-muted">Doctor Address:</p>
       <Form.Group controlId="firstname">
     ...
     <div className="col-lg-4 mb-1">
      ...
      <div className="col-lg-4 mb-4">
       <p className="mb-0 text-muted">Doctor Qualification:</p>
       <Form.Group controlId="firstname">
       <Form.Select onChange={(e)=> (setQualification(e.target.value))}>
               <option className="text-muted">Choose profile ..</option>
               <option value={"1"}>Super Specialist</option>
               <option value={"2"}>Specialist</option>
               <option value={"3"}>Medical officer(MD)/ Dental Surgeon(DDS)</option>
               <option value={"4"}>Assistant Medical Officer(AMO)/ Assistant Dental Officer(ADO)</option>
               <option value={"5"}>Clinical Officer/ Dental Assistant</option>
               <option value={"6"}>Assistant Clinical Officer</option>
               <option value={"8"}>Physiotherapist</option>
               <option value={"9"}>Optometrist</option>
               <option value={"10"}>Audiologist</option>
               <option value={"11"}>Medical attendant</option>
            </Form.Select>
       </Form.Group>
     </div>                 
     ...
     <div className="row m-auto mt-3 ">
        ...
        <Link to=''>
        <button className="btn btn-primary mr-4" onClick={handleSubmit}><span className="p-1">< FaUserCheck/></span>Register Doctor</button> 
        </Link>
